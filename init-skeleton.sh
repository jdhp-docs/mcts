...
TODO_AUTHOR_BEAMER_SHORT_NAME="Decock"

TODO_COPYRIGHT_NOTICE="Copyright (c) 2012,2014,2015,2016 ${TODO_AUTHOR_NAME} (${TODO_AUTHOR_WEB_SITE})"

TODO_DOCUMENT_DATE="May 2012"
TODO_INSTITUTE="Inria Saclay - LRI"
TODO_DOCUMENT_SUBJECT="montecarlo tree search"
TODO_DOCUMENT_KEYWORDS="mcts,uct,montecarlo,reinforcement learning"

TODO_DOCUMENT_TITLE="Monte-Carlo Tree Search"
TODO_DOCUMENT_SUBTITLE="An introduction"
TODO_DOCUMENT_FILE_BASE_NAME="mcts_slides"

TODO_DOCUMENT_GITHUB_ACCOUNT="jdhp-docs"
TODO_DOCUMENT_GITHUB_REPOSITORY_NAME="mcts"
...
sed -i "" \
    ...
    -e "s/TODO_AUTHOR_BEAMER_SHORT_NAME/${TODO_AUTHOR_BEAMER_SHORT_NAME}/g" \
    ...
    AUTHORS meta.make README.rst meta.tex
